...
urlpatterns = [
    ...
    path(
        "estudiantes/nuevo/", EstudianteCreateView.as_view(), name="estudiante-create"
    ),
    path(
    ...
    path(
        "lista_negra/sacar_estudiante/<int:pk>/",
        sacar_estudiante,
        name="sacar_estudiante",
    ),
    # URLs para Libro
    ...
    path(
        "devolver_libro/<int:libro_id>/<int:estudiante_id>/<str:success_url>",
        devolver_libro,
        name="devolver_libro",
    ),
]
